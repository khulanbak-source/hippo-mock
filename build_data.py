...
# ====================================================================
THEMES_HIPPO2 = [
    ("The city", [("SUBURB","An area on the edge of a city where people live."),("MONUMENT","A statue or building that reminds people of an important event."),("FOUNTAIN","A structure that shoots water into the air in a square."),("GALLERY","A place where paintings and art are shown to the public."),("HARBOUR","A safe place by the sea where ships stay."),("AVENUE","A wide street, often with trees on both sides."),("CROSSING","A marked place where people can walk across the road."),("DISTRICT","One particular area of a city."),("PAVEMENT","The path beside a road where people walk."),("COMMUTER","A person who travels to work in the city every day."),("LANDMARK","A famous place that helps you find your way."),("SKYLINE","The outline of a city's tall buildings against the sky.")]),
    ("Weather", [("FORECAST","A report that tells you what the weather will be like."),("BLIZZARD","A severe snowstorm with very strong winds."),("DRIZZLE","Very light, fine rain."),("HUMID","When the air feels warm and full of moisture."),("DROUGHT","A long period with little or no rain."),("BREEZE","A light, gentle wind."),("THUNDER","The loud noise you hear during a storm."),("SHOWER","A short period of rain."),("OVERCAST","When the sky is completely covered with grey clouds."),("FROST","A thin layer of ice on cold surfaces."),("HEATWAVE","A long period of very hot weather."),("RAINBOW","A coloured arch in the sky after rain.")]),
    ("Sport", [("TOURNAMENT","A competition with many matches to find a winner."),("ATHLETE","A person who is good at sport and trains hard."),("REFEREE","The person who controls a match and applies the rules."),("STADIUM","A large place where people watch sports."),("OPPONENT","The person or team you play against."),("VICTORY","A win in a game or competition."),("DEFEAT","When you lose a game."),("TRAINING","Practising regularly to improve at a sport."),("MARATHON","A very long running race of about 42 kilometres."),("CHAMPION","The winner of a competition."),("FITNESS","The state of being healthy and strong."),("COMPETE","To take part in a contest against others.")]),
    ("Films and music", [("ORCHESTRA","A large group of musicians who play together."),("AUDIENCE","The people who watch a film or show."),("DIRECTOR","The person in charge of making a film."),("CHARACTER","A person in a story or film."),("MELODY","A tune; a pleasant series of musical notes."),("RHYTHM","The regular beat in a piece of music."),("SUBTITLE","Words on screen that translate what people say."),("SEQUEL","A film that continues the story of an earlier one."),("COMPOSER","A person who writes music."),("REHEARSE","To practise a play or song before performing."),("PERFORM","To act, sing or play in front of an audience."),("FESTIVAL","An event with many concerts or films over several days.")]),
    ("Friends and family", [("RELATIVE","A member of your family, such as an aunt or cousin."),("NEIGHBOUR","A person who lives near you."),("COLLEAGUE","A person you work with."),("STRANGER","A person you do not know."),("GENEROUS","Happy to give and share with others."),("ARGUMENT","An angry disagreement between people."),("NEPHEW","The son of your brother or sister."),("ADMIRE","To respect and like someone very much."),("SUPPORT","To help someone when they have a problem."),("COMPANY","The pleasant state of being with other people."),("LOYAL","Always faithful to your friends."),("COUSIN","Your aunt's or uncle's child.")]),
    ("Wild animals", [("PREDATOR","An animal that hunts and eats other animals."),("ENDANGERED","In danger of disappearing forever."),("HABITAT","The natural home of an animal or plant."),("JUNGLE","A thick, hot forest full of plants and animals."),("CREATURE","Any living animal."),("NOCTURNAL","Active at night and asleep during the day."),("SURVIVE","To stay alive in difficult conditions."),("MAMMAL","An animal that feeds its babies with milk."),("REPTILE","A cold-blooded animal like a snake or lizard."),("INSECT","A small animal with six legs, such as an ant."),("EXTINCT","No longer existing anywhere on Earth."),("SHELTER","A place that protects an animal from danger.")]),
    ("Festivals", [("CELEBRATE","To do something enjoyable for a special occasion."),("TRADITION","A custom passed down over many years."),("PROCESSION","A line of people moving forward in a ceremony."),("COSTUME","Special clothes worn for a festival or play."),("FIREWORK","It explodes in the sky with colour and noise."),("LANTERN","A light inside a case that you carry or hang."),("CARNIVAL","A street festival with music, dancing and costumes."),("CEREMONY","A formal event to mark an important occasion."),("DECORATE","To make a place look attractive for an event."),("FEAST","A large, special meal for many people."),("CUSTOM","A usual way of doing something in a culture."),("PARADE","A public march to celebrate something.")]),
    ("The home", [("FURNITURE","Tables, chairs and beds in a house."),("WARDROBE","A tall cupboard where you hang your clothes."),("CUPBOARD","A piece of furniture with shelves and doors."),("CEILING","The surface above your head in a room."),("BALCONY","A small platform outside an upstairs window."),("CORRIDOR","A long passage with rooms on each side."),("BASEMENT","A room below the ground floor of a house."),("CURTAIN","Cloth you pull across a window."),("CHORES","Small jobs you do around the house."),("COSY","Warm and comfortable."),("ATTIC","A room in the roof of a house."),("CARPET","A soft cover for the floor.")]),
    ("Feelings", [("NERVOUS","Worried and a little afraid before something."),("CONFIDENT","Sure of yourself and your abilities."),("JEALOUS","Upset because someone has something you want."),("ANXIOUS","Very worried about something."),("GENEROUS","Happy to give and share."),("CURIOUS","Wanting to know or learn about something."),("PATIENT","Able to wait calmly without getting annoyed."),("HONEST","Always telling the truth."),("CHEERFUL","Happy and full of good spirits."),("SELFISH","Caring only about yourself."),("AMBITIOUS","Strongly wanting to succeed."),("PROUD","Pleased about something you have achieved.")]),
    ("A trip", [("ADVENTURE","An exciting and sometimes risky experience."),("EXPEDITION","An organised journey for a special purpose."),("SOUVENIR","Something you buy to remember a place."),("LUGGAGE","The bags and cases you take on a journey."),("PASSPORT","An official document you need to travel abroad."),("JOURNEY","Travelling from one place to another."),("SCENERY","The natural features of a beautiful landscape."),("EXPLORE","To travel around a place to discover it."),("ABROAD","In or to a foreign country."),("BACKPACK","A bag you carry on your back."),("FERRY","A boat that carries people across water."),("GUIDE","A person who shows tourists around.")]),
]
